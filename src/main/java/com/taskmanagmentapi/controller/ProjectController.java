...
import com.taskmanagmentapi.service.ProjectService;
...
public class ProjectController {
    ...
    @PutMapping("/{id}")
    public ProjectResponse updateProject(@PathVariable Long id, @Valid @RequestBody CreateProjectRequest request) {
